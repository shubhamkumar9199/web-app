...
export class ChatService {
  ...
  decideAction(decision: 'approve' | 'reject'): void {
    ...
    // A decision is not a question. Leaving the last one set would offer Try again for
    // something the officer asked earlier, next to the card this decision restores.
