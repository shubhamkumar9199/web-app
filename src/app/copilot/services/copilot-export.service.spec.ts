...
describe('CopilotExportService', () => {
  ...
  describe('exportToPdf', () => {
    ...
    /** A step of zero never advances, which costs the officer the tab rather than the export. */
    it('gives up rather than looping forever on a canvas with no width', async () => {
      renderedWidth = 0;
